...
//		}
		$big_menu = array('javascript:window.top.art.dialog({id:\'add\',iframe:\'?m=Adboard&a=add\', title:\'添加学科\', width:\'600\', height:\'300\', lock:true}, function(){var d = window.top.art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){window.top.art.dialog({id:\'add\'}).close()});void(0);', '添加学科');
		$page = $p->show();
